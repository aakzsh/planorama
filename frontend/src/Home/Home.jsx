...
const Home = () => {
  ...
  const days = [["Monday", monday, selectMonday],["Tuesday", tuesday, selectTuesday],["Wednesday", wednesday, selectWednesday],["Thursday", thursday, selectThursday],["Friday", friday, selectFriday],["Saturday", saturday, selectSaturday],["Saturday", sunday, selectSunday]]
  ...
  return (
    <div className="homescreen">
      <div className="calendar-and-alert">
        ...
        <div
          className="alert-box"
          style={{ backgroundColor: isConflicting ? "#FB7575" : "#79EB44" }}
        >
          <p>
            {isConflicting
              ? "ALERT: youve conflicting agendas, click here to view and fix!"
              : "No issues, all appointments are fine!"}
          </p>
        </div>
      </div>
      ...
      <div className="home-right">
        <div className="create-new-appointment">
          ...
          <div>
            ...
            <div className="legend-div">
              ...
              ></div>
              <p>Existing Conflicts!</p>
            </div>
          </div>
        </div>
        <div className="set-working-hours">
          <strong><p>Set your working days and hours</p></strong>
        ...
        <div className="create-new-appointment">
          <strong><p>Create new appointment</p></strong>
          <div className="setter-box">
                <p>Title</p>
                <input type="text" className="select-datetime" placeholder="Enter Title"/>
                <p>From</p>
